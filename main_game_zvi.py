...
from strategy import BestStrategy, Automatic_BaseStrategy, N_max_strategy, More_then_N_percent_group_strategy
...
strategies = []
strategies.append(Example_strategy(envelopes))                          # return first envelop
